...
![主页面预览 V1](images/main_v1.png)

上图展示了PuffChat应用的主页界面第一版，采用了现代化的玻璃拟态设计风格，清晰展示了用户的健身数据、营养摄入和训练计划等核心信息。

![主页面预览 V2](images/main_v2.png)

上图展示了PuffChat应用的主页界面第二版，在保持原有设计风格的基础上，优化了信息展示的层次感，提升了整体的视觉体验和交互效果。
